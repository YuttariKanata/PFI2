...
public:
    ...
    void clone_from(const PFI2& other);
    [[nodiscard]] bool assign_contents(const PFI2& rhs) noexcept;
    [[nodiscard]] bool assign_abs_contents(const PFI2& rhs) noexcept;
    ...
    [[nodiscard]] bool operator==(const PFI2& rhs) const noexcept;
    ...
    [[nodiscard]] bool sub_inplace(const PFI2& rhs) noexcept;
